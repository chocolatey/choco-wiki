...
##See Also
[[HelpersInstallChocolateyZipPackage|Install-ChocolateyZipPackage]] for installing a zip package.
To add executables to the path see [[HelpersGetChocolateyBins|Get-ChocolateyBins]]
