...
This covers the release notes for the Chocolatey Licensed Extension (chocolatey.extension) package, where the licensed editions of Chocolatey get their enhanced functionality.
